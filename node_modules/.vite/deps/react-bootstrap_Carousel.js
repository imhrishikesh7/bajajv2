...
function useUncontrolled(props, config) {
  return Object.keys(config).reduce(function(result, fieldName) {
    var _extends2;
    var _ref = result, defaultValue = _ref[defaultKey(fieldName)], propsValue = _ref[fieldName], rest = _objectWithoutPropertiesLoose3(_ref, [defaultKey(fieldName), fieldName].map(_toPropertyKey));
...
var CarouselCaption = React5.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
function useMergedRefs(refA, refB) {
  return (0, import_react23.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var TransitionWrapper = import_react24.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react24.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react24.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react24.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react24.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react24.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react24.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react24.useCallback)(normalize(addEndListener), [addEndListener]);
  return (0, import_jsx_runtime6.jsx)(Transition_default, {
    ...
    ) : import_react24.default.cloneElement(children, {
      ref: attachRef
    })
  });
});
...
var Carousel = React11.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime7.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime7.jsx)("span", {
      "aria-hidden": "true",
  ...
  const nextDirectionRef = (0, import_react25.useRef)(null);
  const [direction, setDirection] = (0, import_react25.useState)("next");
  const [paused, setPaused] = (0, import_react25.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react25.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react25.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react25.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react25.useRef)();
  ...
  const handleEnter = (0, import_react25.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null ? void 0 : onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react25.useCallback)(() => {
    setIsSliding(false);
    onSlid == null ? void 0 : onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react25.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null ? void 0 : onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react25.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null ? void 0 : onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react25.useRef)(0);
  const touchDeltaXRef = (0, import_react25.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react25.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react25.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react25.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react25.useRef)();
  (0, import_react25.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react25.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
    onSelect == null ? void 0 : onSelect(index, event);
  }), [indicators, numChildren, onSelect]);
  return (0, import_jsx_runtime8.jsxs)(Component, {
    ref: elementRef,
    ...props,
    onKeyDown: handleKeyDown,
    ...
    children: [indicators && (0, import_jsx_runtime7.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime7.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime7.jsx)(TransitionWrapper_default, {
          in: isActive,
    ...
    }), controls && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime9.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime8.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime7.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime8.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime7.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
